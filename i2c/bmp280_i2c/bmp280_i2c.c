...
#define REG_DIG_H4 _u(0xE4)
#define REG_DIG_H5 _u(0xE5)
...
void bmp280_init() {
    ...
    const uint8_t reg_config_val = ((0x04 << 5) | (0x04 << 2)) & 0xFC;
...
void bmp280_read_raw(int32_t* temp, int32_t* pressure, int32_t* humidity) {
    ...
    i2c_read_blocking(i2c_default, ADDR, buf, 8,
                      false);  // false - finished with bus

    // store the 20/16 bit read in a 32 bit signed integer for conversion
...
int32_t bmp280_convert_temp(int32_t temp, struct bmp280_calib_param* params) {
    // uses the BMP280 calibration parameters to compensate the temperature
    // value read from its registers
...
uint32_t bmp280_convert_humidity(int32_t humidity, int32_t temp,
                                 struct bmp280_calib_param* params) {
    int32_t t_fine = bmp280_convert(temp, params);
    ...
    var1 =
        (var1 -
         (((((var1 >> 15) * (var1 >> 15)) >> 7) * ((int32_t)params->dig_h1)) >>
          4));
    var1 = (var1 < 0 ? 0 : var1);
...
void bmp280_get_calib_params(struct bmp280_calib_param* params) {
    ...
    // read 0x88 - 0xa1
    i2c_write_blocking(i2c_default, ADDR, &reg1, 1,
                       true);  // true to keep master control of bus
    // read in one go as register addresses auto-increment
    i2c_read_blocking(i2c_default, ADDR, buf, NUM_CALIB_PARAMS1,
    ...
    i2c_read_blocking(i2c_default, ADDR, buf, NUM_CALIB_PARAMS2, false);
...
/*
    printf("dig_t1 = 0x%02x, dig_t2 = 0x%02x, dig_t3 = 0x%02x\n", params->dig_t1, params->dig_t2, params->dig_t3);
    printf("dig_p1 = 0x%02x, dig_p2 = 0x%02x, dig_p3 = 0x%02x\n", params->dig_p1, params->dig_p2, params->dig_p3);
    printf("dig_p4 = 0x%02x, dig_p5 = 0x%02x, dig_p6 = 0x%02x\n", params->dig_p4, params->dig_p5, params->dig_p6);
    printf("dig_p7 = 0x%02x, dig_p8 = 0x%02x, dig_p9 = 0x%02x\n", params->dig_p7, params->dig_p8, params->dig_p9);
    printf("dig_h1 = 0x%02x, dig_h2 = 0x%02x, dig_h3 = 0x%02x\n", params->dig_h1, params->dig_h2, params->dig_h3);
    printf("dig_h4 = 0x%02x, dig_h5 = 0x%02x, dig_h6 = 0x%02x\n", params->dig_h4, params->dig_h5, params->dig_h6);
*/
}
...
*/
        ...
        int32_t humidity =
            bmp280_convert_humidity(raw_humidity, raw_temperature, &params);
